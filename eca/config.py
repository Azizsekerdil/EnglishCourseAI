...
APP_NAME = "English Course AI"
APP_SLUG = "EnglishCourseAI"
TARGET_LANG = "en"
...
DB_FILENAME = "EnglishCourseAI.db"
PACK_EXTENSION = ".ecapack"
UI_LANGS = ("tr", "en")
...
def _home() -> Path:
    ...
    if sys.platform == "darwin":
        ...
        # so keep using ~/.englishcourseai while it exists and the new location does not.
...
PALETTES = {
    "dark": {
        ...
        "accent": "#42d6b3", "accent2": "#376fc9", "ok": "#62caa0", "warn": "#e9ad54",
    },
    "light": {
        "deep": "#e8edf6", "bg": "#f5f7fb", "panel": "#ffffff", "card": "#edf1f8",
        "hover": "#dfe6f2", "fg": "#17233c", "muted": "#62708a", "border": "#cbd5e5",
        "accent": "#087f6a", "accent2": "#315eaa", "ok": "#247c5b", "warn": "#9a6713",
    },
}
...
def answer_equal(given: str, expected: str) -> bool:
    # English spelling checks ignore capitalization but keep apostrophes and
    # hyphens meaningful ("dont" is not the same answer as "don't").
    return normalize_exact(given).casefold() == normalize_exact(expected).casefold()
