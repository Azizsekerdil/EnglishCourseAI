...
GUIDES = [
    ("KULLANIM_KILAVUZU", "tr", "English Course AI - Kullanım Kılavuzu"),
    ("USER_GUIDE", "en", "English Course AI - User Guide"),
]
...
h1 { font-size: 24pt; margin: 0 0 4pt; color: #0E8C6E; border-bottom: 3px solid #0E8C6E; padding-bottom: 8pt; }
h2 { font-size: 15pt; margin: 22pt 0 6pt; color: #0E8C6E; border-bottom: 1px solid #d7dbe2; padding-bottom: 3pt; page-break-after: avoid; }
...
pre { background: #f4f6fa; border: 1px solid #dde2ea; border-left: 3px solid #0E8C6E; border-radius: 4px; padding: 8pt 10pt;
...
th { background: #0E8C6E; color: #fff; text-align: left; padding: 5pt 7pt; font-weight: 600; }
td { border-bottom: 1px solid #dfe4ec; padding: 5pt 7pt; vertical-align: top; }
tr:nth-child(even) td { background: #f7f9fc; }
blockquote { margin: 8pt 0; padding: 6pt 12pt; background: #f4f6fa; border-left: 3px solid #0E8C6E; color: #38404f; }
a { color: #0E8C6E; text-decoration: none; }
